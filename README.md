...
This project addresses the inefficiencies of manual retail inventory tracking. By leveraging machine learning, NeuroCommerce analyzes historical transaction logs to predict future demand, allowing shop managers to act proactively.

### Key Objectives

* **Automated Forecasting**: Reduce human error in stock replenishment.
* **Resource Efficiency**: Utilize optimized Random Forest regressor algorithms to minimize computational strain.
* **Dashboard Intelligence**: Provide real-time visualization of stock health and predictive analytics.
...
* ✅ **Core Analytics API**: Successfully calculates KPIs and demand predictions.
* ✅ **ML Pipeline**: Random Forest model is integrated and retraining on dataset updates.
* ✅ **Inventory Grid**: Automated stock monitoring and restock triggers.
* ✅ **UI/UX**: Responsive dashboard with dark/light mode support.
...
* **Oloc Chandro (Partha)** (ID: 232311131)
* **Partho Kumar Ray** (ID: 232311136)
